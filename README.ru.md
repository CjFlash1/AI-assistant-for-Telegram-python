...
## 🐳 Развертывание (Docker) - Рекомендуется для Oracle Cloud

Если вы запускаете бота на сервере (например, **Oracle Cloud**, VPS или рядом с n8n), используйте Docker. Это гарантирует правильную установку всех библиотек для работы с QR-кодами.
